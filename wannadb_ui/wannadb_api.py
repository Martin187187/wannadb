...
from wannadb.matching.custom_match_extraction import ExactCustomMatchExtractor, ForestCustomMatchExtractor,\
    RegexCustomMatchExtractor, NgramCustomMatchExtractor
            ...
            matching_phase = Pipeline(
                [
                    ...
                    RankingBasedMatcher(
                        ...
                        find_additional_nuggets=ForestCustomMatchExtractor()
                    )
                ]
            )
